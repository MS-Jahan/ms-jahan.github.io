...
const Portfolio = ({headerPlacement}) => {

    Scripts("assets/vendor/swiper/swiper-bundle.min.js");
    //Scripts("assets/vendor/isotope-layout/isotope.pkgd.js")
    Scripts("assets/vendor/isotope-layout/isotope.pkgd.min.js")
    Scripts("assets/vendor/glightbox/js/glightbox.min.js")
    Scripts("assets/vendor/swiper/swiper-bundle.min.js")
    Scripts("assets/js/main.js");

    useEffect(() => {
        headerPlacement("portfolio");
    })
